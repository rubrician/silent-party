...
import com.tinglabs.silent.party.player.JcPlayerExceptions.AudioListNullPointerException;
...
public class JcPlayerView extends LinearLayout implements
    ...
    public static final String TAG = "JcPlayerView";
    ...
    private void init() {
        ...
        this.btnPlay.setTag(R.drawable.ic_play_arrow_white_36dp);
    ...
    public void onClick(View view) {
        if (initialized)
            if (view.getId() == R.id.btn_play) {
                ...
                if (btnPlay.getTag().equals(R.drawable.ic_pause_white_24dp))
                    pause();
                else
                    continueAudio();
            }
    ...
    public void createJcAudioPlayer() {
        if (jcAudioPlayer == null) {
    ...
    public void onCompletedAudio() {
        Log.d(TAG, "Track complete - playing next...");
        resetPlayerInfo();
    ...
    public void onPaused() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            btnPlay.setBackground(ResourcesCompat.getDrawable(getResources(),
                    R.drawable.ic_play_arrow_white_24dp, null));
        } else {
            btnPlay.setBackgroundDrawable(ResourcesCompat.getDrawable(getResources(),
                    R.drawable.ic_play_arrow_white_24dp, null));
        }
        btnPlay.setTag(R.drawable.ic_play_arrow_white_24dp);
    }

    @Override
    public void onContinueAudio() {
        Log.d(TAG, "Continuing track...");
        dismissProgressBar();
    }
    ...
    public void onPlaying() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            btnPlay.setBackground(ResourcesCompat.getDrawable(getResources(),
                    R.drawable.ic_pause_white_24dp, null));
        } else {
            btnPlay.setBackgroundDrawable(ResourcesCompat.getDrawable(getResources(),
                    R.drawable.ic_pause_white_24dp, null));
        }
        btnPlay.setTag(R.drawable.ic_pause_white_24dp);
    }
