...
import com.tinglabs.silent.party.player.JcPlayerExceptions.AudioAssetsInvalidException;
import com.tinglabs.silent.party.player.JcPlayerExceptions.AudioFilePathInvalidException;
import com.tinglabs.silent.party.player.JcPlayerExceptions.AudioRawInvalidException;
import com.tinglabs.silent.party.player.JcPlayerExceptions.AudioUrlInvalidException;
...
public class JcPlayerService extends Service implements
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        Log.d(TAG, "Prepared " + currentJcAudio.getTitle());
        mediaPlayer.start();
        isPlaying = true;
